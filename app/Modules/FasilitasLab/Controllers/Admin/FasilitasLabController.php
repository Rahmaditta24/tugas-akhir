...
namespace App\Modules\FasilitasLab\Controllers\Admin;
    ...
    public function importExcel(Request $request)
    {
        ...
        foreach ($request->data as $index => $row) {
            ...
            $data = [
                ...
                'latitude' => (float)str_replace(',', '.', $normalizedRow['latitude'] ?? -6.2),
                'longitude' => (float)str_replace(',', '.', $normalizedRow['longitude'] ?? 106.8),
