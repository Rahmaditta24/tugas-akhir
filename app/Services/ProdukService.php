    ...
    private function getFilterOptions()
    {
        return [
            'bidang' => Cache::remember('filter_produk_bidang', 7200, function () {
                return DB::table('produk')->select('bidang')->whereNotNull('bidang')->distinct()->orderBy('bidang')->pluck('bidang')->filter()->values();
            }),
            'tkt' => Cache::remember('filter_produk_tkt', 7200, function () {
                return DB::table('produk')->select('tkt')->whereNotNull('tkt')->distinct()->orderBy('tkt')->pluck('tkt')->filter()->values();
            }),
