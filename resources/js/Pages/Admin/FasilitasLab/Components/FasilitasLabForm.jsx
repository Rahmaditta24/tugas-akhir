            ...
            <div className="bg-white rounded-lg shadow-sm">
                <div className="p-6 border-b">
                    <h2 className="text-xl font-semibold text-slate-800">
                        {isEdit ? 'Edit Data Fasilitas Lab' : 'Tambah Data Fasilitas Lab'}
                    </h2>
                    <p className="text-sm text-slate-600 mt-1">
                        {isEdit ? 'Perbarui informasi fasilitas laboratorium' : 'Lengkapi informasi dasar fasilitas laboratorium baru'}
                    </p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="p-6">
                    ...
                    <div className="flex items-center justify-end gap-3 pt-6 border-t">
                        ...
                        >
                            {processing ? 'Menyimpan...' : (isEdit ? 'Simpan Perubahan' : 'Tambah Data')}
                        </button>
                    </div>
                </form>
            </div>
