                ...
                <div className="bg-white rounded-lg shadow-sm">
                    ...
                    <AdminTable
                        ...
                        columns={[
                            ...
                            { key: 'nama_produk', title: 'Nama Produk', sortable: true, render: (v) => <div className="max-w-md truncate" title={fmt(v)}>{display(v)}</div> },
                            { key: 'institusi', title: 'Institusi', sortable: true, render: (v) => <div className="max-w-xs truncate" title={fmt(v)}>{display(v)}</div> },
                            { key: 'bidang', title: 'Bidang', sortable: true, className: 'min-w-[160px]', render: (v) => <Badge color="purple">{display(v)}</Badge> },
