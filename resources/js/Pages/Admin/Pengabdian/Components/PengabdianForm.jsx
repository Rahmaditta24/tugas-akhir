...
export default function PengabdianForm({ context }) {
    const {
        data, setData,
        processing, errors,
            ...
            <div className="bg-white rounded-lg shadow-sm">
                <div className="p-6 border-b">
                    <h2 className="text-xl font-semibold text-slate-800">
                        {isEdit ? 'Edit Data Pengabdian' : 'Tambah Data Pengabdian'}
                    </h2>
                    <p className="text-sm text-slate-600 mt-1">
                        {isEdit ? 'Perbarui informasi data pengabdian' : 'Isi form di bawah untuk menambah data pengabdian baru'}
                    </p>
                </div>
