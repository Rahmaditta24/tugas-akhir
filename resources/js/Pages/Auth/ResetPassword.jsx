        ...
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 to-slate-100 p-4 sm:p-0">
            ...
            <div className="w-full max-w-md">
                ...
                <div className="text-center mb-6 sm:mb-8">
                    <h1 className="text-2xl sm:text-3xl font-bold text-slate-800 mb-1 sm:mb-2">Buat Password Baru</h1>
                    <p className="text-sm sm:text-base text-slate-600">
                        Pastikan password baru Anda aman dan memenuhi kriteria.
                    </p>
                </div>
                ...
                <form onSubmit={submit} className="bg-white rounded-xl shadow-lg p-6 sm:p-8">
                    ...
                    <div className="mb-4 text-left">
                        <label htmlFor="password_confirmation" className="block text-sm font-medium text-slate-700 mb-1.5 sm:mb-2">
                            Konfirmasi Password
                        </label>
                        <div className="relative">
                            <input
                                ...
                                className={`w-full px-4 py-2 text-base border rounded-lg focus:outline-none focus:ring-2 pr-10 border-slate-300 focus:ring-blue-500`}
                                required
                            />
                            <button
                                type="button"
